...
import { ImageBackground, ListRenderItemInfo, ScrollView, View, LogBox } from 'react-native';
 ...
 */
//LogBox.ignoreWarnings(['VirtualizedLists should never be nested inside plain ScrollViews']);
